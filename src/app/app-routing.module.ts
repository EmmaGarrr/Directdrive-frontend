...
import { HetznerManagementComponent } from './admin-panel/hetzner-management/hetzner-management.component';
...
const routes: Routes = [
  ...
  { 
    ...
    children: [
      ...
      { path: 'google-drive-files', component: GoogleDriveManagementComponent },
      { path: 'hetzner-files', component: HetznerManagementComponent },
